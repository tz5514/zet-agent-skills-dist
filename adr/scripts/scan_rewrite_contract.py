"""Scan-rewrite gate contract helpers, owned by the revise delivery flow.

The scan-rewrite loop is part of the delivery completion flow that `revise` owns
(originally embedded in `produce`); these helpers are its single authority.
"""
